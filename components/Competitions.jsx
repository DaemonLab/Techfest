      ...
      >
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-flow-row gap-x-5 gap-y-8 h-100">
          <motion.div
            ...
            animate={animation}
          >
            <img className="object-fill w-full h-49" src="https://images.unsplash.com/photo-1502581827181-9cf3c3ee0106?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=420&q=80" alt="Flower and sky"/>
          ...
          >
            ...
            <h4 className="mb-3 text-xl font-semibold tracking-tight text-white">This is the title</h4>
            <p className="leading-normal text-gray-100">Lorem ipsum dolor, sit amet cons ectetur adipis icing elit. Praesen tium, quibusdam facere quo laborum maiores sequi nam tenetur laud.</p>
            <button className='one'><b>Register</b></button>
            </div>
          </motion.div>
          <motion.div
            className="relative overflow-hidden rounded-lg shadow-lg cursor-pointer"
          ...
          >
            ...
            <h4 className="mb-3 text-xl font-semibold tracking-tight text-white">This is the title</h4>
            <p className="leading-normal text-gray-100">Lorem ipsum dolor, sit amet cons ectetur adipis icing elit. Praesen tium, quibusdam facere quo laborum maiores sequi nam tenetur laud.</p>
            <button className='three'><a href="https://www.codepen.io/jcoulterdesign" target="_blank"><b>.</b></a></button>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <button className='one'>Play some <b>amazing</b> games</button>
            <button className='two'>Continue shopping <b>now</b></button>
            <button className='three'><a href="https://www.codepen.io/jcoulterdesign" target="_blank"><b>.</b></a></button>
            <button className='four'>Change some <b>settings</b></button>
            <button className='five'>Do something <b>fun</b> today</button>
            </div>
